...
export const products: Product[] = [
  ...
  {
    id: "monitor-riser-usb",
    slug: "monitor-riser-with-usb-hub",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    ...
    priceRange: "$20–$28",
    badge: "Best Budget",
    name: "Monitor Riser with USB Hub and Storage",
    shortDescription: "A practical budget riser that adds 4.5 inches of monitor height, a full-width storage shelf, and a built-in USB hub - all for under $28.",
    bestFor: [
      "Budget-conscious students who want USB charging alongside their riser",
      "Dorm setups where outlet space is limited",
      "Single-monitor desks under 48 inches",
    ],
    notIdealFor: [
      "Monitors wider than 30 inches (platform may be undersized)",
      "Users who need to adjust screen height frequently",
    ],
    specs: {
      "Platform Size": "15.7\" x 9\"",
      "Raised Height": "4.5 inches",
      "Max Load": "44 lbs",
      "USB Ports": "2x USB 3.0 + 1x USB-C",
      "Material": "ABS plastic with steel reinforcement",
      "Under-Screen Clearance": "4.5 inches internal",
      "Assembly": "None required",
    },
    pros: [
      "Built-in USB hub keeps ports accessible on the front edge",
      "Under-screen shelf fits a compact keyboard, notebooks, or accessories",
      "Raises monitor to ergonomic eye-level height at a budget price",
      "No setup required - unbox and place",
      "Front USB-C port is convenient for phone charging",
    ],
    cons: [
      "Fixed height only - not adjustable once assembled",
      "Plastic construction feels lighter than steel alternatives",
      "USB 3.0 ports max at 5Gbps - adequate for most peripherals but not Thunderbolt",
    ],
    scores: {
      overall: 8.2,
      smallSpaceFit: 8.8,
    ...
    reviewSummary:
      "The most practical budget riser in this category. The integrated USB hub solves a real pain point in dorm setups where outlet strips are already full, and the storage shelf is genuinely useful for a compact keyboard or phone. Build quality is plastic-tier, not metal, but for under $28 it delivers the core ergonomic benefit and the USB convenience without compromise.",
    alternatives: ["bamboo-stand-drawer", "compact-riser-trays"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "bamboo-stand-drawer",
    slug: "bamboo-monitor-stand-with-drawer",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    ...
    shortDescription: "A natural bamboo riser with a slide-out drawer and open shelf - the best-looking stand in this roundup and completely plastic-free.",
    bestFor: [
      "Minimalist and Scandi-inspired desk aesthetics",
      "Students who want desk storage without plastic",
      "Anyone who values sustainable materials in their workspace",
    ],
    notIdealFor: [
      "High-humidity environments (bamboo can warp over time)",
      "Users who need a USB hub or cable routing built in",
    ],
    specs: {
      "Platform Size": "16\" x 9.8\"",
      "Raised Height": "4.7 inches",
      "Drawer Dimensions": "10.6\" x 6.3\" x 1.8\" internal",
      "Max Load": "22 lbs",
      "Material": "100% natural bamboo",
      "Finish": "Natural/light oil finish",
      "Assembly": "Minimal - legs slot in without tools",
    },
    pros: [
      "Natural bamboo construction is plastic-free and biodegradable",
      "Slide-out drawer stores small accessories completely out of sight",
      "Open shelf underneath fits a keyboard, notepad, or phone",
      "Warm natural grain adds visual appeal to any desk setup",
      "Legs slot together without tools in about 2 minutes",
    ],
    cons: [
      "Bamboo warps if exposed to persistent moisture or direct sunlight",
      "No USB ports or cable routing",
      "22 lb max load is lower than steel alternatives",
    ],
    scores: {
      overall: 8.4,
      smallSpaceFit: 8.6,
    ...
    reviewSummary:
      "The best-looking option in this group and the only fully natural material pick. The drawer is a meaningful differentiator - it completely hides small accessories (cables, pens, sticky notes) that would otherwise clutter the shelf. The warm bamboo tone works exceptionally well on light-toned or white desks. Not the right pick for users who need USB connectivity or very high load capacity, but for aesthetics and organization it leads the field.",
    alternatives: ["monitor-riser-usb", "minimalist-wood-monitor-riser"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "adjustable-riser-tiers",
    slug: "adjustable-stackable-monitor-riser",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    ...
    name: "Adjustable Stackable Monitor Riser",
    shortDescription: "Three height settings via stackable riser tiers let you dial in the exact monitor elevation for your seated position - rare flexibility at this price.",
    bestFor: [
      "Users who are not sure of their ideal monitor height",
      "Shared desks where multiple people at different heights need to adjust",
      "Anyone upgrading from a fixed-height riser and wanting flexibility",
    ],
    notIdealFor: [
      "Users who want to change height without any disassembly",
      "Ultrawide monitors wider than 34 inches",
    ],
    specs: {
      "Platform Size": "15.5\" x 9.5\"",
      "Height Settings": "3 levels: 2.75\", 3.75\", 4.75\"",
      "Max Load": "55 lbs",
      "Material": "Cold-rolled steel, powder coat finish",
      "Under-Screen Clearance": "Up to 4.75 inches depending on tier",
      "Assembly": "Stackable tiers, no tools required",
    },
    pros: [
      "Three distinct height levels accommodate different seated positions",
      "Cold-rolled steel handles large and heavy monitors confidently",
      "Powder coat finish resists scratches and smudges",
      "Riser tiers separate and reconfigure without tools",
      "Flat platform works well for wide monitors and dual-display trays",
    ],
    cons: [
      "Changing height requires lifting your monitor off and stacking/unstacking tiers",
      "No integrated USB ports or cable routing",
      "Tiers can rattle slightly if not perfectly aligned",
    ],
    scores: {
      overall: 8.5,
      smallSpaceFit: 8.7,
    ...
    reviewSummary:
      "The right choice for anyone unsure of their ideal monitor height. The three-tier system covers the 2.75 to 4.75 inch range that accommodates most seated positions and desk types. Cold-rolled steel gives it a sturdiness edge over plastic risers at similar price points. The one real inconvenience is that changing the height requires temporarily moving your monitor - a minor issue for a change you should only need to make once.",
    alternatives: ["monitor-riser-usb", "single-arm-gas-spring"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "single-arm-gas-spring",
    slug: "single-monitor-arm-gas-spring",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    ...
    name: "Single Monitor Arm with Gas Spring",
    shortDescription: "A gas-spring monitor arm that clamps to your desk edge and completely eliminates the monitor footprint, freeing 100% of your desk surface below the screen.",
    bestFor: [
      "Single-monitor users who want maximum desk surface reclamation",
      "Remote workers who frequently reposition their screen throughout the day",
      "Standing desk users who need height adjustability beyond what a riser offers",
    ],
    notIdealFor: [
      "Monitors without VESA mount holes on the back panel",
      "Very lightweight desks that flex under clamp pressure",
      "Users who want a no-installation solution",
    ],
    specs: {
      "VESA Compatibility": "75x75mm and 100x100mm",
      "Screen Size Range": "13–27 inches",
      "Max Weight Capacity": "14.3 lbs",
      "Mount Options": "C-clamp (up to 3.15\" desk thickness)",
      "Height Adjustment": "Up to 20 inches above desk",
      "Rotation": "360° swivel, 90° tilt, portrait/landscape",
      "Cable Management": "Built-in routing channels along arm",
    },
    pros: [
      "Completely eliminates the monitor base footprint from your desk",
      "Gas spring provides smooth, one-finger height and angle adjustment",
      "Full 360-degree swivel and tilt for any viewing position",
      "Integrated cable channels route DisplayPort, HDMI, and USB cleanly",
      "Switches between landscape and portrait orientation with one rotation",
    ],
    cons: [
      "Requires VESA holes on monitor back (most monitors since 2015 have them)",
      "One-time 20-30 minute installation",
      "Not suitable for monitors over 27 inches or heavier than 14 lbs",
    ],
    scores: {
      overall: 9.0,
      smallSpaceFit: 9.8,
    ...
    reviewSummary:
      "The best choice for maximizing desk space on a small desk. Once installed, the monitor floats above the desk and the entire area underneath is usable again. The gas spring mechanism makes repositioning effortless - you can raise, lower, swivel, or tilt with one hand. The investment in a 20-minute setup pays back every day. If your monitor has VESA holes and you want every inch of desk space back, this is the pick.",
    alternatives: ["dual-arm-gas-spring", "adjustable-riser-tiers"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "compact-riser-trays",
    slug: "compact-monitor-riser-organizer-trays",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    ...
    name: "Compact Monitor Riser with Organizer Trays",
    shortDescription: "A compact steel riser with built-in organizer compartments under the platform - designed specifically for small desks that need tidy storage without a large footprint.",
    bestFor: [
      "Students who want under-screen organization for pens, cables, and small accessories",
      "Desks under 40 inches where a wide platform riser takes too much surface",
      "Users who need divided storage compartments rather than one open shelf",
    ],
    notIdealFor: [
      "Monitors wider than 27 inches (platform is compact by design)",
      "Users who want USB ports integrated into the stand",
    ],
    specs: {
      "Platform Size": "13.7\" x 9\"",
      "Raised Height": "4 inches",
      "Max Load": "33 lbs",
      "Under-Screen Compartments": "2 divided storage sections",
      "Material": "Powder-coated steel",
      "Rubber Feet": "4 non-slip pads on base",
      "Assembly": "None required",
    },
    pros: [
      "Divided storage compartments keep accessories sorted without extra organizers",
      "Compact footprint is the smallest platform size in this category",
      "Powder-coated steel is sturdy without adding excess weight",
      "4-inch elevation reaches ergonomic height for most 24-inch monitors",
      "Ships fully assembled",
    ],
    cons: [
      "Smaller platform may not support wider ultrawide monitors evenly",
      "No USB hub or cable management features",
      "2 compartments may be insufficient for users with many small items",
    ],
    scores: {
      overall: 8.0,
      smallSpaceFit: 9.3,
    ...
    reviewSummary:
      "The best choice for very small desks where a full-size riser platform would feel oversized. The divided compartments directly below the screen are a smart design detail - they put frequently accessed items (pens, chargers, sticky notes) in the most accessible zone of your desk without adding any new footprint. Best paired with a standard 24-27 inch monitor on a desk under 40 inches.",
    alternatives: ["monitor-riser-usb", "bamboo-stand-drawer"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "dual-arm-gas-spring",
    slug: "dual-monitor-arm-gas-spring",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    image: "https://m.media-amazon.com/images/I/81VYepdKQ4L._AC_SL1500_.jpg",
    ...
    priceRange: "$55–$75",
    badge: "Best for Dual Monitors",
    name: "Dual Monitor Arm with Gas Spring",
    shortDescription: "Two independent gas-spring arms on a single desk clamp - the cleanest way to run dual monitors on a small desk without a single base footprint.",
    bestFor: [
      "Dual-monitor setups on desks under 55 inches",
      "Remote workers who need one landscape and one portrait screen",
      "Anyone whose desk surface is dominated by two monitor bases",
    ],
    notIdealFor: [
      "Monitors that lack VESA mount holes",
      "Desks under 24 inches deep (arms need depth clearance behind screens)",
      "Single-monitor setups (the single arm is a better value)",
    ],
    specs: {
      "Arms": "2 fully independent gas-spring arms",
      "VESA Compatibility": "75x75mm and 100x100mm",
      "Screen Size Range (each)": "13–27 inches",
      "Max Weight per Arm": "17.6 lbs",
      "Mount Options": "C-clamp or grommet",
      "Desk Thickness Range": "0.5\"–3.15\"",
      "Cable Management": "In-arm cable routing on both arms",
    },
    pros: [
      "Two fully independent arms adjust without affecting the other screen",
      "Eliminates both monitor bases, reclaiming the full dual-monitor footprint",
      "Grommet mount option available for desks with cable holes",
      "Both arms support portrait orientation for coding or document viewing",
      "Cable routing channels on each arm eliminate cable clutter completely",
    ],
    cons: [
      "Requires VESA holes on both monitors",
      "Installation takes 30-45 minutes with basic hand tools",
      "Not suitable for monitors heavier than 17.6 lbs each",
    ],
    scores: {
      overall: 9.1,
      smallSpaceFit: 9.7,
    ...
    reviewSummary:
      "The single best upgrade for a dual-monitor setup on a compact desk. Two bases from 24-27 inch monitors can consume more than two feet of desk depth combined - this arm reclaims all of it. The independent gas springs mean you can angle each screen differently (common when one is used for reference and one for active work). The installation investment is real, but the payoff is permanent.",
    alternatives: ["single-arm-gas-spring", "dual-monitor-arm-mount"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "mesh-monitor-stand",
    slug: "mesh-monitor-stand-with-organizer",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    image: "https://m.media-amazon.com/images/I/91Q5V3J+X2L._AC_SL1500_.jpg",
    amazonUrl: "https://amzn.to/4f9nIXP",
    priceRange: "$22–$30",
    badge: "Best for Airflow",
    name: "Mesh Metal Monitor Stand with Side Organizer",
    shortDescription: "An open-grid steel mesh stand with built-in side organizer tiers - maximizes airflow underneath while adding sorted desktop storage on both sides.",
    bestFor: [
      "Users who store a laptop or external drive underneath their monitor",
      "Setups where heat management under the screen matters",
      "Desks that need visible, tiered side organization alongside the monitor",
    ],
    notIdealFor: [
      "Users who want items stored completely out of sight",
      "Setups where mesh texture may scratch items stored underneath",
    ],
    specs: {
      "Platform Size": "16\" x 9.5\"",
      "Raised Height": "5 inches",
      "Side Organizer Tiers": "2 tiers on each side",
      "Max Load": "44 lbs",
      "Material": "Powder-coated steel mesh",
      "Ventilation": "Full-grid open mesh platform",
      "Assembly": "Side panels click in, 5 minutes",
    },
    pros: [
      "Open mesh platform allows full airflow to anything stored underneath",
      "Side organizer tiers keep phones, notebooks, and accessories within reach",
      "5-inch elevation is the tallest fixed-height option in this group",
      "Powder-coated steel mesh is more durable than solid ABS plastic risers",
      "Side tiers expand the usable storage zone beyond just the under-screen shelf",
    ],
    cons: [
      "Mesh surface can leave marks on soft items stored underneath",
      "Side organizer adds 3 inches of width on each side - needs more horizontal space",
      "Open design means items underneath are always visible",
    ],
    scores: {
      overall: 8.3,
      smallSpaceFit: 8.2,
    ...
    reviewSummary:
      "A practical choice for users who store a laptop, external drive, or other device underneath their monitor. The open mesh prevents heat buildup that can be an issue with solid-platform risers in enclosed under-screen spaces. The side tiers are a genuinely useful feature - they place frequently used items in easy reach without requiring a separate desk organizer. Note the wider total footprint when the side panels are attached.",
    alternatives: ["compact-riser-trays", "bamboo-stand-drawer"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },

  {
    id: "minimalist-wood-monitor-riser",
    slug: "minimalist-wood-monitor-stand",
    categorySlug: "desk-setup",
    subcategorySlug: "monitor-stands",
    ...
    name: "Minimalist Solid Wood Monitor Stand",
    shortDescription: "A clean solid-wood monitor riser with a rear cable management cutout - for setups where the look of your desk matters as much as the function.",
    bestFor: [
      "Warm or natural desk aesthetics (white oak, walnut, or light wood desks)",
      "Content creators and photographers who want a visually clean setup",
      "Anyone who wants a premium-looking stand without a monitor arm",
    ],
    notIdealFor: [
      "Users who need USB ports or active cable routing",
      "High-humidity or sunny workspaces where wood grain may shift over time",
    ],
    specs: {
      "Platform Size": "16\" x 9.5\"",
      "Raised Height": "4.5 inches",
      "Max Load": "33 lbs",
      "Material": "Solid rubberwood, natural oil finish",
      "Cable Cutout": "Rear channel for cable routing",
      "Legs": "Solid wood, bolt-on (hex key included)",
      "Finish Options": "Natural / walnut",
    },
    pros: [
      "Solid wood construction has premium weight and finish absent from plastic alternatives",
      "Rear cable cutout routes power and display cables neatly below the platform",
      "Natural grain pattern means no two stands look identical",
      "Available in natural and walnut finishes to match different desk tones",
      "Pairs exceptionally well with light-toned or wood-grain desk surfaces",
    ],
    cons: [
      "Higher price than steel or plastic options for equivalent function",
      "No USB ports or USB-C passthrough",
      "Wood can show surface marks if items are slid on the underside shelf",
    ],
    scores: {
      overall: 8.6,
      smallSpaceFit: 8.5,
    ...
    reviewSummary:
      "The highest-quality material option in this roundup for users who prioritize the look of their workspace. Solid rubberwood has a warmth and density that manufactured wood composites don't replicate, and the natural grain makes every stand slightly unique. The cable cutout at the back is a practical detail that solid wood risers often omit - here it allows clean cable routing without any visible wire runs on the platform. A premium choice for aesthetics-forward setups.",
    alternatives: ["bamboo-stand-drawer", "mesh-monitor-stand"],
    relatedGuideSlugs: ["monitor-stands-small-desks"],
  },
