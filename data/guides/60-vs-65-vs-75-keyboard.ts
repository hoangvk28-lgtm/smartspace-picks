...
export const sixtyVs65Vs75KeyboardGuide: Guide = {
  title: "60% vs 65% vs 75% Keyboard: Which Size Should You Get?",
  slug: "60-vs-65-vs-75-keyboard",
  ...
  mainKeyword: "60 vs 65 vs 75 keyboard",
  subKeywords: [
    "65 vs 75 keyboard",
    "60 percent vs 65 percent keyboard",
    "best compact keyboard size",
    "75 percent keyboard vs tkl",
    "keyboard size for gaming",
  ],
  heroImage: "/images/guides/60-vs-65-vs-75-keyboard/01-60-vs-65-vs-75-hero.webp",
  thumbnailImage: "/images/guides/60-vs-65-vs-75-keyboard/01-60-vs-65-vs-75-hero.webp",
  ...
  faq: [
    {
      question: "What is the difference between a 65% and 75% keyboard?",
      answer:
    ...
    {
      question: "Is a 60% or 65% keyboard better for gaming?",
      answer:
    ...
    {
      question: "Which keyboard size is best for programming?",
      answer:
    ...
    {
      question: "Should I get a 65% or 75% for a small desk?",
      answer:
    ...
    {
      question: "Is a 60% keyboard worth it?",
      answer:
...
![60% vs 65% vs 75% keyboard layout side by side comparison](/images/guides/60-vs-65-vs-75-keyboard/02-layout-comparison.webp)`,
    },
    {
      heading: "The Key Differences Explained",
      body: `### What You Lose Going from 75% to 65%
...
- Hot-swap, wireless, and build quality options: available across all three layouts`,
    ...
    {
      heading: "60% vs 65% vs 75% for Gaming",
      body: `### FPS and Competitive Gaming (CS2, Valorant, Apex Legends)
...
![65% keyboard setup for FPS gaming with extended mouse area](/images/guides/60-vs-65-vs-75-keyboard/03-65-percent-keyboard-fps-gaming.webp)
...
- MMO / RPG with heavy F-key macros: 75% or TKL`,
    ...
    {
      heading: "60% vs 65% vs 75% for Work and Programming",
      body: `**75% wins for work, clearly.**
...
![75% keyboard for home office and programming productivity](/images/guides/60-vs-65-vs-75-keyboard/04-75-percent-keyboard-work-programming.webp)
...
| VS Code with fully custom keybindings | 65% |`,
    ...
    {
      heading: "65% vs 75% Direct Comparison",
      body: `| Factor | 65% | 75% |
|--------|-----|-----|
...
![65% vs 75% keyboard direct comparison on desk](/images/guides/60-vs-65-vs-75-keyboard/06-65-vs-75-direct-comparison.webp)`,
    },
    {
      heading: "60% vs 65% Direct Comparison",
      body: `| Factor | 60% | 65% |
|--------|-----|-----|
...
![60% keyboard setup for minimalist travel and compact desk](/images/guides/60-vs-65-vs-75-keyboard/05-60-percent-keyboard-travel-setup.webp)
...
For nearly everyone, the 65% is the better buy over the 60%. The functional difference far outweighs the 0.5-inch width savings.`,
    },
    {
      ...
      body: `| Your situation | Recommendation |
|----------------|---------------|
...
![Best keyboard size recommendation guide for every use case](/images/guides/60-vs-65-vs-75-keyboard/07-best-size-recommendation.webp)

**Related guides:**
- [TKL vs Full-Size Keyboard](/guide/tkl-vs-full-size-keyboard) - step up from compact layouts
- [Keyboard Size Chart](/guide/keyboard-size-chart) - full dimensions for every layout
- [Best Mechanical Keyboards Under $100](/guide/best-mechanical-keyboard-under-100) - top picks across 65%, 75%, and TKL`,
    },
  ],
};
