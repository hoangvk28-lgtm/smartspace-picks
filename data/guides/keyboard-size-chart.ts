...
export const keyboardSizeChartGuide: Guide = {
  ...
  subKeywords: [
    ...
    "65 percent keyboard size",
    "75 percent keyboard dimensions",
    "tkl keyboard size cm",
    "full size keyboard dimensions",
  ],
  heroImage: "/images/guides/keyboard-size-chart/01-keyboard-size-chart-hero.webp",
  thumbnailImage: "/images/guides/keyboard-size-chart/01-keyboard-size-chart-hero.webp",
  ...
  faq: [
    {
      question: "What is the standard keyboard size?",
      answer:
    ...
    {
      question: "What keyboard size is best for a small desk?",
      answer:
    ...
    {
      question: "What is the difference between 65% and 75%?",
      answer:
    ...
    {
      question: "How big is a 75% keyboard in cm?",
      answer:
    ...
    {
      question: "What is keycap size 1u?",
      answer:
    ...
    {
      question: "What is the difference between Cherry MX Red and Brown?",
      answer:
  ...
  sections: [
    {
      heading: "",
      body: `> **Quick answer:** A standard full-size keyboard is approximately 17.5" x 5.0" (44.5cm x 12.7cm). A TKL is ~14.0" x 4.8" (35.5cm x 12.2cm). A 75% is ~12.6" x 4.1" (32cm x 10.4cm). A 65% is ~11.5" x 4.1" (29cm x 10.4cm). A 60% is ~11.0" x 4.1" (28cm x 10.4cm). All measurements vary slightly by manufacturer.

## Quick Picks by Layout

If you already know which size you want, here are the top budget picks:

| Size | Best Budget Pick | Price | |
|------|-----------------|-------|--|
| 65% | Redragon K631 PRO (Triple-mode wireless, hot-swap) | ~$45-55 | <a href="https://www.amazon.com/dp/B09ZNMRMHD?tag=deskfinds0d-20" rel="nofollow sponsored noopener noreferrer" target="_blank" style="display:inline-block;background:#FF9900;color:white;padding:5px 12px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none;white-space:nowrap;">Check price on Amazon</a> |
| 75% | EPOMAKER x AULA F75 (Gasket mount, knob, PBT keycaps) | ~$60-65 | <a href="https://www.amazon.com/dp/B0CNT61VMZ?tag=deskfinds0d-20" rel="nofollow sponsored noopener noreferrer" target="_blank" style="display:inline-block;background:#FF9900;color:white;padding:5px 12px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none;white-space:nowrap;">Check price on Amazon</a> |
| TKL | Keychron C3 Pro (Hot-swap, PBT, compact build) | ~$35-45 | <a href="https://www.amazon.com/dp/B0CRDKQNQ5?tag=deskfinds0d-20" rel="nofollow sponsored noopener noreferrer" target="_blank" style="display:inline-block;background:#FF9900;color:white;padding:5px 12px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none;white-space:nowrap;">Check price on Amazon</a> |

For full reviews and more picks: [Best Mechanical Keyboards Under $100](/guide/best-mechanical-keyboard-under-100)
...
![Master keyboard size chart comparison showing all layouts from 40% to 100%](/images/guides/keyboard-size-chart/02-master-keyboard-size-layout-chart.webp)`,
    },
    {
      ...
      body: `### 40% Keyboard (~9.6" / 24.4cm wide)
...
**Who uses it:** Ultra-portable users, minimalist enthusiasts, heavy Fn-layer users
**Who should avoid it:** Anyone who types numbers, uses shortcuts, or is still learning keyboard positions
...
**Common 60% keyboards:** Anne Pro 2, Ducky One 2 Mini
**Who uses it:** Minimalists, portable typists, gamers who prefer the smallest possible footprint
**Who should avoid it:** Anyone who uses arrow keys or F-keys regularly
...
Compared to 60%: +0.5" wider, +dedicated arrow keys
Compared to 75%: -1.1" narrower, -physical F-row (F1-F12 via Fn layer only)

**Common 65% keyboards:** Keychron K6, HyperX Alloy Origins 65, RK Royal Kludge RK68
...
![40%, 60%, and 65% keyboard size comparison](/images/guides/keyboard-size-chart/03-best-keyboard-size-for-small-desk.webp)`,
    },
    {
      ...
      body: `### 75% Keyboard (~12.6" / 32.0cm wide)
...
Compared to 65%: +1.1" wider, +physical F-row (F1-F12 as dedicated keys)
Compared to TKL: -1.4" narrower, same functional key set (nav keys compressed)
...
**Common 75% keyboards:** Keychron V1, RK Royal Kludge RK84, GMMK Pro
**Who uses it:** Home office workers, programmers, anyone who needs F-keys but wants a smaller board than TKL
...
**Who uses it:** Gamers who want mouse space without giving up the F-row, office workers who don't need a numpad, anyone upgrading from full-size
**Who should avoid it:** Accountants, data entry professionals, anyone who uses the numpad daily
...
**Who uses it:** Users who need a numpad but want a slightly smaller footprint than full-size
**Who should avoid it:** Anyone who confuses the numpad location due to missing gap
...
![Keyboard size comparison visual showing width of each layout](/images/guides/keyboard-size-chart/05-keycap-size-chart-visual.webp)`,
    },
    {
      ...
      body: `The two most popular keyboard sizes for gaming are **65%** and **75%**.

**Why 65% is popular in FPS gaming:**
Mouse clearance. On a right-handed setup, a narrower keyboard shifts the mouse zone 2.5" closer to the body compared to TKL. This lowers the elbow angle and allows larger arm-sweep mouse movements - a practical advantage in games like CS2, Valorant, and Apex Legends that use low DPI.

**Why 75% is more popular for hybrid gaming/work setups:**
75% retains dedicated F-keys. Many games bind abilities, map views, or settings to F1-F12. Without physical function keys, these require a two-key Fn combination in the middle of a game. For titles that use F-key binds, 75% eliminates this problem while saving 1.4" over TKL.
...
![Best keyboard size for gaming by game type](/images/guides/keyboard-size-chart/06-mechanical-keyboard-switch-color-comparison.webp)`,
    },
    {
      ...
      body: `## Laptop Keyboard Size vs. Desktop Keyboard
